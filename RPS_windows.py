...
import time
import random
os.system('title Rock Paper Scissors Game ~ By Jordi Serrano')
pts_machine = 3
pts_player = 3
os.system('cls')
...
while pts_machine or pts_player >= 0: # establece que haga todo esto hasta que tenga valor a 0 de vidas
	...
	e_player = str(input(" Elige: PIEDRA , PAPEL, TIJERAS: "))
	...
	if e_player =='piedra' and e_machine == 'tijeras':
		pts_machine = pts_machine-1
		stat=' Gana el Jugador'
		print(m_scissors)
		print(p_rock)
	elif e_player == 'piedra' and e_machine == 'papel':
		stat=' Gana el Ordenador'
		pts_player = pts_player-1
		print(m_paper)
		print(p_rock)
	elif e_player == 'piedra' and e_machine == 'piedra':
		stat=' Empate'
		print(m_rock)
		print(p_rock)	
	elif e_player == 'papel' and e_machine == 'tijeras':
		pts_player = pts_player-1
		stat=' Gana el Ordenador'
		print(m_scissors)
		print(p_paper)	
	elif e_player == 'papel' and e_machine == 'papel':
		stat=' Empate'
		print(m_paper)
		print(p_paper)	
	elif e_player == 'papel' and e_machine == 'piedra':
		pts_machine = pts_machine-1
		stat=' Gana el Jugador'
		print(m_rock)
		print(p_paper)	
	elif e_player == 'tijeras' and e_machine == 'tijeras':
		stat=' Empate'
		print(m_scissors)
		print(p_scissors)	
	elif e_player == 'tijeras' and e_machine == 'papel':
		pts_machine = pts_machine-1
		stat=' Gana el Jugador'
		print(m_paper)
		print(p_scissors)	
	elif e_player == 'tijeras' and e_machine == 'piedra':
		pts_player = pts_player-1
		stat=' Gana el Ordenador'
		print(m_rock)
		print(p_scissors)	
...
#	print(" Elección del jugador: "+e_player)
	...
	print("  ")
	time.sleep(2)
	enter_space =input('''Press Enter to Continue
''')
	os.system('cls')
